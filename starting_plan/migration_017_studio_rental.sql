...
VALUES
  ...
  -- Services
  ('Party Helper (per hour)',  'A professional party server who handles setup, keeps food stations stocked, assists guests, and manages cleanup throughout the event.', 'service-add-on', 2500, NULL, 'per_hour', false, 1, '🙋‍♀️', ARRAY['studio-rental'], true),
  ...
  ('Photo Booth',              'Open-air photo booth with props for your guests.',                                                                                       'service-add-on', 10000, NULL, 'flat', true,  3, '📸', ARRAY['studio-rental'], true),
  ('Linen Rentals',            'For all tables during your party room rental.',                                                                                          'service-add-on', 5000, NULL, 'flat', false, 4, '🧺', ARRAY['studio-rental'], true),
  ...
  ('Pizza - Assorted Pies (per person)', 'Assorted toppings, regular & specialty pies.',                                                          'food-add-on',  800, NULL, 'per_person', false, 2, '🍕', ARRAY['studio-rental'], true),
  ...
  -- Beverages
  ('Open Fridge (per person)', 'Your favorite canned & bottled non-alcoholic drinks, fully stocked and chilled — grab and enjoy.', 'beverage-add-on', 500, NULL, 'per_person', false, 1, '🥤', ARRAY['studio-rental'], true);
