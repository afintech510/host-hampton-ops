/**
 * memory_bootstrap.ts
 * Host Hampton Agent System — Base Memory Bootstrap
 *
 * Upserts all base namespace entries into Supabase agent_memory table.
 * Run ONCE on first deploy, then run memory_bootstrap_v1.2.ts immediately after.
 *
 * Usage:
 *   cd scripts && npm install && npm run bootstrap
 *   (or: tsx memory_bootstrap.ts with SUPABASE_URL + SUPABASE_SERVICE_KEY in env)
 */
...
const memory: MemoryEntry[] = [
...

  {
    namespace: 'brand',
    key: 'hashtags',
    description: 'Pre-approved hashtag sets by category — use these, do not invent new ones',
    value: {
      kids_birthday: [
...

  {
    ...
    description: 'All available party themes — base entry, overridden by v1.2 bootstrap with confirmed catalog',
    value: {
      themes: [
        { name: 'Spa Party', tier: 'standard', age_range: '5-12', highlights: ['facials', 'nail painting', 'spa robes', 'cucumber water'] },
        { name: 'Swiftie Party', tier: 'standard', age_range: '6-14', highlights: ['friendship bracelet station', 'Taylor trivia', 'Eras Tour decor', 'karaoke'] },
        { name: 'Barbie Party', tier: 'standard', age_range: '4-10', highlights: ['pink decor', 'fashion design station', 'Barbie trivia'] },
        { name: 'Unicorn Party', tier: 'standard', age_range: '3-8', highlights: ['pastel decor', 'craft station', 'unicorn horns'] },
        { name: 'Slime Party', tier: 'standard', age_range: '5-12', highlights: ['make your own slime', 'add-ins and glitter', 'take-home containers'] },
        { name: 'Glow Party', tier: 'premium', age_range: '5-14', highlights: ['UV black lights', 'glow accessories', 'neon decor', 'DJ upgrade available'] },
        { name: 'Toddler Soft Play Party', tier: 'standard', age_range: '1-4', highlights: ['soft play equipment', 'sensory stations', 'parent-friendly setup'] },
        { name: 'Trucker Hat Party', tier: 'standard', age_range: '7-14', highlights: ['custom hat design', 'iron-on patches', 'take home creation'] },
        { name: 'Sweets & Treats Decorating', tier: 'standard', age_range: '4-12', highlights: ['decorate cookies/cupcakes', 'candy stations', 'take-home boxes'] }
      ],
      add_ons: [
        'Photo booth', 'Glitter tattoos', 'Hair tinsel', 'Balloon garland upgrade',
        'Candy wall', 'Slime add-on station', 'DJ upgrade', 'Glow upgrade package', 'Piñata'
      ]
    }
  },
...

  {
    ...
    value: {
      january:   { push: ['New Year booking campaign', "Valentine's Day party planning"], email: 'New year — book early, slots fill fast', social_theme: 'Fresh start, new themes for 2026' },
      february:  { push: ["Valentine's Day permanent jewelry", 'Galentines workshop', 'Valentine party add-on'], email: "Gift a permanent bracelet for Valentine's Day", social_theme: 'Love-themed parties, jewelry gift guide' },
      march:     { push: ['Spring break camps/parties', 'Easter-themed party push'], email: 'Spring break party ideas + availability', social_theme: 'Spring vibes, pastel themes, spring break fun' },
      april:     { push: ['Spring market vendor spots', 'Spring birthday peak begins'], email: 'Spring market announcement + spring party themes', social_theme: 'Spring parties, market preview, birthday season' },
      may:       { push: ["Mother's Day permanent jewelry", 'Spring birthday peak', 'End of school parties'], email: "Mother's Day gift — permanent jewelry + party slots", social_theme: 'Moms + kids, celebration season, jewelry gifts' },
      june:      { push: ['Summer camps/parties launch', 'End of school year parties', 'Summer birthday peak'], email: 'Summer camp and party schedule — book now', social_theme: "Summer fun, beach themes, school's out" },
      july:      { push: ['Summer birthday peak (highest volume month)', 'Beach and tropical themes'], email: "Last summer slots — book before they're gone", social_theme: 'Peak summer parties, showcasing real events' },
      august:    { push: ['Back to school launch', 'Fall booking campaign opens', 'Labor Day events'], email: 'Book fall parties now — September fills fast', social_theme: 'Summer wrap-up, fall preview, back to school fun' },
      september: { push: ['Fall birthday season', 'Fundraiser outreach to schools/PTAs STARTS NOW'], email: 'Fundraiser partnership invite to schools + teams', social_theme: 'Fall themes, cozy vibes, fundraiser program' },
      october:   { push: ['Halloween workshops', 'Halloween party theme', 'Fall pop-up market'], email: 'Halloween party + adult workshop announcement', social_theme: 'Halloween, spooky fun, fall market' },
      november:  { push: ['Holiday market planning', 'Holiday party booking opens', 'Friendsgiving workshops'], email: 'Holiday party — book your December date now', social_theme: 'Holiday prep, market teasers, gratitude content' },
      december:  { push: ['Holiday market', 'Holiday party peak', 'Gift card push', 'New Year preview'], email: 'Gift card + last minute holiday booking', social_theme: 'Holiday magic, real events, gift card promos' }
    }
  },
...
async function bootstrap() {
  console.log('🚀 Starting Host Hampton memory bootstrap (base)...\n')
  ...
  console.log(`\n${'─'.repeat(50)}`)
  console.log(`Base bootstrap complete: ${loaded} loaded, ${failed} failed`)
  ...
  console.log('\n👉 Next step: run memory_bootstrap_v1.2.ts to load addendum entries.')
  console.log('   npm run bootstrap:v1.2')
}
