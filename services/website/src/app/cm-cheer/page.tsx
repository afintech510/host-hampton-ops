            ...
            <div className="p-6 md:p-8 bg-gray-50 border-y border-gray-200">
              ...
              <div id="digitalPaymentInfo" className="hidden bg-white border border-gray-200 rounded-xl p-4 sm:p-6 shadow-sm mb-2 flex-col md:flex-row items-center gap-4 sm:gap-6">
                ...
                <div className="text-center md:text-left">
                  ...
                  <a href="https://www.venmo.com/CM_PAL" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-3 sm:px-5 py-2 bg-black text-white rounded-full font-mono text-xs sm:text-sm font-bold border border-gray-800 max-w-full hover:bg-gray-900 transition-colors">
