...
import {
  User, Mail, Phone, Baby, Users, Loader2, Bookmark, PartyPopper, Clock,
...
function BookingForm() {
  ...
  return (
    <div>
      {/* The <h1> and the intro copy that used to live here are now in the
          server component (page.tsx). They were inside this Suspense boundary,
          and a `useSearchParams()` client page bails out to the FALLBACK during
          static prerender — so /book shipped ten characters of HTML reading
          "Loading...". See page.tsx. */}
